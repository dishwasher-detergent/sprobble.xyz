...
module.exports = async function (req, res) {
  ...
  if (
    ...
    const week_of_year = utils.getWeekOfYear();
    ...
    const fetched_items = await database.listDocuments(
      ...
      "stats",
      [
        sdk.Query.equal("user.user_id", data.user_id),
    ...
    if (fetched_items.documents.length > 0) {
      ...
      await database.updateDocument(
        ...
        {
          number_of_plays: fetched_items.documents[0].count + 1,
      ...
      await database.createDocument("645c032960cb9f95212b", "stats", {
        user: [data.user_id],
        number_of_plays: 1,
