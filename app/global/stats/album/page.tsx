...
async function getTop() {
  const album: Models.Document & Album = await fetch(
    `${process.env.NEXT_PUBLIC_APPWRITE_ENDPOINT}/v1/databases/645c032960cb9f95212b/collections/album/documents?queries[0]=limit(1)&queries[1]=orderDesc($createdAt)`,
    {
      next: {
        revalidate: 60,
      },
