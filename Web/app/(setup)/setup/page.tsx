    ...
    <section className="flex flex-col items-center justify-center gap-2 gap-2">
      <div className="flex w-full flex-col items-center justify-center gap-4 rounded-3xl bg-secondary px-4 py-12">
        <div className="flex items-center gap-4">
          <LucideAlertTriangle className="h-10 w-10 flex-none rounded-xl bg-primary-foreground p-2 text-primary" />
        ...
        <p className="text-xl">
          We're getting everything setup for you, once we're done you'll
