export default function Privacy() {
  return (
    <section className="prose dark:prose-invert py-8">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Sprobble.xyz.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Sprobble.xyz, accessible from{" "}
            <a
              href="https://sprobble.xyz"
      ...
      <ul>
        <li>By email: hello@sprobble.xyz</li>
      </ul>
    </section>
  );
}
