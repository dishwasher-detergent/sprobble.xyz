...
export function SpotifyLink({ type, id }: SpotifyLinkProps) {
  return (
    <a
      ...
      target="_blank"
      className="absolute bottom-0 left-0 z-10 flex flex-row items-center gap-2 p-2 xl:-left-[5%] xl:bottom-auto xl:top-0"
    >
      <div className="flex h-12 flex-row items-center gap-2 overflow-hidden rounded-3xl bg-primary pl-2 pr-4 font-bold text-white">
